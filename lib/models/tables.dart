...
class FeedSources extends Table {
  ...
  BoolColumn get notify => boolean().withDefault(const Constant(false))();  // notifica nuovi articoli
  BoolColumn get isActive => boolean().withDefault(const Constant(true))();
  TextColumn get language => text().nullable()();
  DateTimeColumn get lastFetched => dateTime().nullable()();
  TextColumn get etag => text().nullable()();          // per GET condizionale
  TextColumn get lastModified => text().nullable()();  // per GET condizionale
...
class Articles extends Table {
  ...
  IntColumn get duplicateOf => integer().nullable()();  // id dell'articolo originale
